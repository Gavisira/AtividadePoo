...
public class Graduacao implements ICategoria {
	
	public String nome;
	public ArrayList<Disciplina> curriculo = new ArrayList<Disciplina>();
	public int creditosNecessarios = 50;
...
public Graduacao() {}
	...
	public Graduacao(String nome, ArrayList<Disciplina> disciplinas) {
		this.nome = nome;
	...
	public boolean VerificaAprovacao(ArrayList<Disciplina> disciplinas) {
		...
		for(Disciplina p : disciplinas) {
			if(p.isAprovado())creditos += CalculaCreditos(p);
		}
	...
	public int CalculaCreditos(Disciplina disciplina) {
		return (int)disciplina.getHorasAulaMateria()/60;
	}
